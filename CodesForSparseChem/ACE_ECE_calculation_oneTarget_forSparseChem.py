...
def calculateErrors_oneTarget(y_true, y_score, num_bins=10):
    '''
    Args:
    ...
    def main():
        ...
        nonzero_entries=y_true.nonzero()[0]
        y_score_target=y_score[nonzero_entries]
        y_true_target=y_true[nonzero_entries]
