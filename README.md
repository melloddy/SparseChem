...
* __--weights_class | --task_weights | --weights_classification__: CSV file with columns task_id, training_weight, aggregation_weight (for classification tasks) (str)
* __--weights_regr | --weights_regression__: CSV file with columns task_id, training_weight, aggregation_weight (for regression tasks) (str)
